                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      id="email"
                      name="email"
                      className="py-3 px-4 block w-full border-gray-200 border-2 focus:outline-blue-500 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none"
                      required
