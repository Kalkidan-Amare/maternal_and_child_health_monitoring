...
const About = () => {
  return (
    <div>
      <section className="bg-white dark:bg-gray-900 mb-10 md:mb-32" id="about">
          ...
          <div className="mr-auto place-self-center lg:col-span-6">
            ...
            <div className="flex flex-col justify-center mt-8 rounded-sm border-4 border-emerald-700 border-solid max-md:max-w-full">
              <div className="flex-wrap gap-y-5 justify-between  max-md:max-w-full md:flex-nowrap flex">
                <div className="flex flex-col  rounded-xl p-4  w-full">
                  <h4 className="font-semibold text-lg text-gray-800 dark:text-neutral-200">
                    Free Plan
                  </h4>
                  <span className="mt-2  text-gray-800 font-semibold dark:text-neutral-200">
                  ...
                  <ul className="mt-2 space-y-2.5 text-sm">
                    <li className="flex space-x-2">
                      <svg
                        className="flex-shrink-0 mt-0.5 size-4 text-emerald-600 dark:text-emerald-500"
        ...
        <button
          type="button"
          className="py-4 px-6 inline-flex items-center gap-x-2 rounded-br-3xl border border-gray-200 text-primary text-xl bg-primary text-white hover:border-primary hover:bg-emerald-600 hover:text-white disabled:opacity-50 disabled:pointer-events-none transition-all duration-300"
        >
          Get Started
        </button>
        </div>
