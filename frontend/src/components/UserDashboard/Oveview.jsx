      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
        ...
        <div className="flex flex-col bg-white border shadow-sm rounded-xl">
          <div className="p-4 md:p-5">
            ...
            <div className="mt-1 flex items-center gap-x-2">
              <h3 className="text-xl sm:text-2xl font-medium text-gray-800">320</h3>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
        <div className="p-4 md:p-5 min-h-[410px] flex flex-col bg-white border shadow-sm rounded-xl">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-sm text-gray-500">Rate</h2>
        ...
        <div className="p-4 md:p-5 min-h-[410px] flex flex-col bg-white border shadow-sm rounded-xl">
          <div className="flex justify-between items-center">
            <div>
              <h2 className="text-sm text-gray-500">Comparison</h2>
              <p className="text-xl sm:text-2xl font-medium text-gray-800">Nutritional Status</p>
            </div>
