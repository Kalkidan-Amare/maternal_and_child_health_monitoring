    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surveyor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='mother_info', to='User.surveyorprofile')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.TextField()),
                ('submission_date', models.DateField(auto_now_add=True)),
                ('surveyor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='antenatal_follow_up', to='User.surveyorprofile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('surveyor', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='postnatal_follow_up', to='User.surveyorprofile')),
            ],
        ),
    ]
